...
<div class="card card-warning">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('editpost') }}">
            @csrf
            <input type="hidden" name="primary" value="{{ $book->no_kamar }}">
            <div class="row">
                <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                        <label>Nama Konsumen</label>
                        <input type="text" name="konsumen" class="form-control" value="{{ $book->nama_konsumen }}" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
                        <label>No. KTP</label>
                        <input type="text" name="ktp" class="form-control" value="{{ $book->no_ktp }}" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input type="date" name="lhr" class="form-control" value="{{ $book->tgl_lahir }}" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>No. Telp</label>
                        <input type="text" name="telp" class="form-control" value="{{ $book->no_telp }}" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
                        <label>Jenis Kamar</label>
                        <select class="form-control" name="jenis">
                            <option>{{ $book->jenis }}</option>
                            @foreach ($jenis as $j)
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="in" class="form-control" value="{{ $book->tgl_in }}" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
                        <label>Tanggal Check-Out</label>
                        <input type="date" name="out" class="form-control" value="{{ $book->tgl_out }}" placeholder="Enter ...">
                    </div>
